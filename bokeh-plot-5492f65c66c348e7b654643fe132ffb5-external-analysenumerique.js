(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("9b00db1b-c203-44f6-ade4-11edbec7e2f9");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '9b00db1b-c203-44f6-ade4-11edbec7e2f9' but no matching script tag was found. ")
        return false;
      }
