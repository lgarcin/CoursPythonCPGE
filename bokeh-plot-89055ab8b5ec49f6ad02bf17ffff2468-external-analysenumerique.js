(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("2d7838bc-40a5-4008-b9d2-d0c2315bf351");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '2d7838bc-40a5-4008-b9d2-d0c2315bf351' but no matching script tag was found. ")
        return false;
      }
