(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("24a23359-9f1e-4fc9-9806-7ab5519a1e31");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '24a23359-9f1e-4fc9-9806-7ab5519a1e31' but no matching script tag was found. ")
        return false;
      }
