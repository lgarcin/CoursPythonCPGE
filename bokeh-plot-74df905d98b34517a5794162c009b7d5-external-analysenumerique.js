(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("131288e8-a6d1-4ed7-ae3f-becb588f792d");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '131288e8-a6d1-4ed7-ae3f-becb588f792d' but no matching script tag was found. ")
        return false;
      }
