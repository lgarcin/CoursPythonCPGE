(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a65a101d-7194-402b-ae1f-36d92e51f704");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a65a101d-7194-402b-ae1f-36d92e51f704' but no matching script tag was found.")
        }
