(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("b202273e-05a9-46a8-975c-1c7c32818afc");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'b202273e-05a9-46a8-975c-1c7c32818afc' but no matching script tag was found. ")
        return false;
      }
