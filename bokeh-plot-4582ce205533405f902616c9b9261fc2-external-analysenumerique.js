(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("36bfb272-c94d-486f-bd6b-bea3a755773a");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '36bfb272-c94d-486f-bd6b-bea3a755773a' but no matching script tag was found. ")
        return false;
      }
